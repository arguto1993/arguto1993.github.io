    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100">
      ...
      <div className="px-4 py-6 grid gap-6 md:grid-cols-[180px_1fr] lg:flex lg:gap-6 lg:items-start">
        ...
        <main className="min-w-0 lg:flex-1">
          {loading && <p className="text-sm text-gray-500">Loading data.json…</p>}
...
function Centered({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 p-6">
      {children}
    </div>
  );
}
